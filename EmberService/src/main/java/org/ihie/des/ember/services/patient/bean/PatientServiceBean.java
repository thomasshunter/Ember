...
{
    public static final String PATIENT_QUERY_BY_FIRST_LAST_MRN_GENDER_DOB_ORG   = "PATIENT_QUERY_BY_FIRST_LAST_MRN_GENDER_DOB_ORG";
    public static final String PATIENT_QUERY_BY_INSTITUION_ID_AND_PERSON_ID     = "PATIENT_QUERY_INSTITUTION_PERSON_ID";
    ...
    public static String getPatientByGivenNameFamilyNameAndGenderQuery()
    {
    ...
    public static String getPatientByGivenFamilyBirthdateGenderPhoneQuery()
    {
        StringBuilder query = new StringBuilder();
    ...
    public static String getPatientQuery( String patientQueryByType )
    {
        ...
        if( PatientServiceBean.PATIENT_QUERY_BY_FIRST_LAST_MRN_GENDER_DOB_ORG.equals( patientQueryByType ) )
        {
            query.append( "\n    per.NAME_LAST = ? "                    );
            query.append( "\n    AND "                                  );
            query.append( "\n    per.NAME_FIRST = ? "                   );            
        ...
        else if( PatientServiceBean.PATIENT_QUERY_BY_LAST_AND_FIRST_NAMES.equals( patientQueryByType ) )
        {
            query.append( "\n    per.NAME_LAST = ? "                    );
            query.append( "\n    AND "                                  );
            query.append( "\n    per.NAME_FIRST = ? "                   );
        }
        else if( PatientServiceBean.PATIENT_QUERY_BY_INSTITUION_ID_AND_PERSON_ID.equals( patientQueryByType ) )
        {
            query.append( "\n    pat.INSTITUTION_ID = ? "               );
            query.append( "\n    AND "                                  );
            query.append( "\n    pat.MEDICAL_RECORD_NUMBER = ? "        );
