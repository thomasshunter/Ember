...
public class MyOrganization extends Organization
{
    ...
    /**
     * This is a composite extension, containing further extensions instead of a
     * value. The class "EmergencyContact" is defined at the bottom of this
     * file.
     */
    ...
    /*
     * ***************************** Boilerplate methods- Hopefully these will
     * be removed or made optional in a future version of HAPI but for now they
     * need to be added to all block types. These two methods follow a simple
     * pattern where a utility method from ElementUtil is called and all fields
     * are passed in.
     *****************************/
     ...
     * extensions. It is referenced by the field myEmergencyContact above.
     */
    @Block
    public static class EmergencyContact extends BaseIdentifiableElement implements IExtension
    {
        ...
        /*
         * ***************************** Boilerplate methods- Hopefully these
         * will be removed or made optional in a future version of HAPI but for
         * now they need to be added to all block types. These two methods
         * follow a simple pattern where a utility method from ElementUtil is
         * called and all fields are passed in.
         *****************************/
